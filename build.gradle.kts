...
paperweight {
    serverProject.set(project(":masami-server"))
    ...
    useStandardUpstream("pufferfish") {
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("masami-api"))
            serverOutputDir.set(layout.projectDirectory.dir("masami-server"))
        }
    }
}
